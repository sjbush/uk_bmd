...
I apologise for the error (a _== 1_ instead of _>= 1_ in the code!) but emphasise that it affects only a small proportion of the total (<5% of birth records, principally those from Yorkshire) and that it does not materially alter any of the conclusions drawn in previously published work. Indeed, the BMD data analysed in [Bush 2019](https://doi.org/10.1080/00277738.2018.1536186) and [Bush 2023](https://doi.org/10.5195/names.2023.2500), for example, did not even use the full set of birth records but instead cross-referenced them with marriage and death records to create conservative subsets; in this respect, double-counted records would have been filtered out prior to any analysis. Moreover, while the combined set of birth records (inclusive of this small proportion of double-counted records) were analysed in [Bush 2020](https://doi.org/10.1080/00277738.2020.1775471) to chart patterns of alliterative name use over time (Figure 3 of this paper), as a control, this analysis was also repeated for subsets of the data, including for regions where reference numbers were indeed unique; this resulted in "no observable difference in the trends illustrated in Figure 3".
