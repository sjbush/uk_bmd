...
I apologise for the error (a _== 1_ instead of _>= 1_ in the code) but emphasise that it affects only a small proportion of the total (<5% of birth records, principally those from Yorkshire) and that it does not materially alter any of the conclusions drawn in previously published work. Indeed, the subsets of BMD data used in [Bush 2019](https://doi.org/10.7488/ds/2294) and [Bush 2023](https://doi.org/10.5195/names.2023.2500), for example, did not even use the birth records as they were but cross-referenced them with marriage and death records as part of their analyses; in this respect, 'double-counted birth records' would have been filtered out as part of this process.
